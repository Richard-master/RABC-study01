...
public interface ResourceAPI {
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "resourceAddDTO", dataTypeClass = ResourceAddDTO.class, value = "新增【资源】参数", paramType = "body"),
    })
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "resourceUpdateDTO", dataTypeClass = ResourceUpdateDTO.class, value = "修改【资源】参数", paramType = "body"),
    })
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "id", dataTypeClass = Integer.class, value = "【资源】id", paramType = "path"),
    })
