...
public interface RoleAPI {
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "roleAddDTO", dataTypeClass = RoleAddDTO.class, value = "新增【角色】参数", paramType = "body"),
    })
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "roleUpdateDTO", dataTypeClass = RoleUpdateDTO.class, value = "修改【角色】参数", paramType = "body"),
    })
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "id", dataTypeClass = Long.class, value = "【角色】id", paramType = "path"),
    })
